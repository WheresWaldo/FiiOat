# Release Creation Instructions for v17_r47
...
2. **Fill the form**:
   - **Tag**: `v17_r47` (must match exactly)
   - **Target**: `main`
...
1. **Release URL**: https://github.com/WheresWaldo/FiiOat/releases/tag/v17_r47
...
- **Tag**: v17_r40
- **Title**: FiiOat v17_r47 - Stable Release
- **File**: FiiOat_v17_r47.zip
- **Notes**: Content from RELEASE_NOTES_current.md

## Important Notes

- The tag `v17_r47` already exists in the repository (was created earlier)
